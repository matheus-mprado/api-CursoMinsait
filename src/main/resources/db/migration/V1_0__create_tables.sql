...
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'admin','root','$2a$12$LEQZsOjaVz7l3BFo2cHm6ePcdmthXYJtBbNP6h.8aNoshViFNllTK','admin@outlook.com','ESCRITA_CLIENTE,LEITURA_CLIENTE,ESCRITA_USUARIO,LEITURA_USUARIO');
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'usuarioTeste','usuarioTeste ','$2a$12$EiVgErLoUZI0ZTI1hBRYRu6RXawyLYwilDig2kzIl9B8iAl177KYi','usuarioTeste@outlook.com','ESCRITA_CLIENTE,LEITURA_CLIENTE');
